...
var items = [
  '<div class="item"><div class="item__body"><div class="item__content"><div class="item__thumb" style="background-image: url(http://userserve-ak.last.fm/serve/500/89294613/Watching+Movies+with+the+Sound+Off+PNG.png)"></div><h4 class="item__title"><span>Watching Movies with the Sound Off</span><small>Mac Miller</small></h4></div><div class="delete"><i class="fa fa-times-circle delete__icon"></i></div></div></div>',
  '<div class="item"><div class="item__body"><div class="item__content"><div class="item__thumb" style="background-image: url(http://userserve-ak.last.fm/serve/500/92879483/Old.jpg)"></div><h4 class="item__title"><span>Old</span><small>Danny Brown</small></h4></div><div class="delete"><i class="fa fa-times-circle delete__icon"></i></div></div></div>',
  '<div class="item"><div class="item__body"><div class="item__content"><div class="item__thumb" style="background-image: url(http://userserve-ak.last.fm/serve/500/92652447/Nostalgic+64+curry.jpg)"></div><h4 class="item__title"><span>Nostalgic 64</span><small>Denzel Curry</small></h4></div><div class="delete"><i class="fa fa-times-circle delete__icon"></i></div></div></div>',
